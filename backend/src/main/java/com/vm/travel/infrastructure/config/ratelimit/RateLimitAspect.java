package com.vm.travel.infrastructure.config.ratelimit;

import com.vm.travel.infrastructure.exceptions.RateLimitException;
...
public class RateLimitAspect {
     ...
     */
    @Before("@annotation(com.vm.travel.infrastructure.config.ratelimit.RateLimitProtection)")
